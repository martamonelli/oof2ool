...
samps_slowest = np.arange(nmax_fastest*ratio)
samps_fastest = np.arange(nmax_fastest)*ratio

plt.plot(samps_slowest, theta_005_450[:nmax_fastest*ratio], label='theta for 0.05rpm and 45deg, stretched')
plt.plot(samps_fastest, theta_030_450[:nmax_fastest], label='theta for 0.30rpm and 45deg')
plt.legend()
